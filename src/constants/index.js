...
},
{
  ...
  points: [
    ...
    "Created web apps with implementation of RESTful API",
...
const projects = [
  {
    name: "Robo Friends",
    description:
      "My first react project. A beginner-friendly, responsive and fun web app that allows users to filter through the robots.",
    tags: [
      {
        name: "react",
  ...
  },
  {
    name: "Dcord",
    description:
      "A personalized discord clone built with Next.js, offering seamless communication, custom servers, and rich multimedia features tailored just for you.",
    tags: [
      {
        name: "Next.js",
        color: "blue-text-gradient",
